# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in tgsqlserve.
...
import tgsqlserve
from tgsqlserve import model, lib
...
base_config.update_blueprint({
    'use_sqlalchemy': True,
    'model': tgsqlserve.model,
    'DBSession': tgsqlserve.model.DBSession,
})
...
base_config.update_blueprint({
    ...
    'sa_auth.cookie_secret': "bf330598-8d2c-4e7f-982a-74afbea2f064",
